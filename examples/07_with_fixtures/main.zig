...
const CharacterAnimPlayer = gfx.AnimationPlayer(CharacterAnim);
...
pub fn main() !void {
    ...
    var anim_player = CharacterAnimPlayer.init(allocator);
    ...
    var current_anim: CharacterAnim = .idle;
    var flip_x = false;
    ...
    while (!rl.windowShouldClose()) {
        ...
        var anim = registry.get(CharacterAnimation, player);
